...
namespace AAG_Water
{
    internal class UnfocusedRainAugmentation : Augmentation
    {
        public override string Name => "Unfocused Rain";

        public override Type DefaultProcessor => typeof(UnfocusedRainProcessor);
        ...
        /// <summary>
        /// Intensity of blur applied to foreground (Applied after all raindrops are rendered)
        /// </summary>
        [Description("Intensity of blur applied to foreground (Applied after all raindrops are rendered)")]
